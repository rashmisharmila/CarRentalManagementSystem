...
import lk.ijse.carrentalmanagementsystem.AppInitializer;
...
public class Dialog {
    ...
    public enum Type {INFOR, WARNING, ERROR, SUCCESS}
    ...
    private static VBox createHeader(Type type) {
        ...
        switch (type) {
            case INFOR:
                ...
                icon = new ImageView(new Image("/src/lk/ijse/carrentalmanagementsystem/assets/icon/inforr.png"));
                break;
            case WARNING:
                color = Color.web("#FC6E51");
                icon = new ImageView(new Image("/src/lk/ijse/carrentalmanagementsystem/assets/icon/wrrorng.png"));
                break;
            case ERROR:
                color = Color.web("#ED5565");
                icon = new ImageView(new Image("/src/lk/ijse/carrentalmanagementsystem/assets/icon/erorr.png"));
                break;
            case SUCCESS:
                color = Color.web("#02C852");
                icon = new ImageView(new Image("/src/lk/ijse/carrentalmanagementsystem/assets/icon/succss.png"));
                break;
        }
